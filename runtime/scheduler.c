...
static Closure *Closure_return(__cilkrts_worker *const w, worker_id self,
    ...
    while (true) {
        ...
        *lht_ptr = NULL;
        ...
        Closure_set_status(child, CLOSURE_RUNNING);
    ...
    // Cilk_exception_handler ended up pushing a stack frame onto child, to
    // do reductions.  Because there are no reductions to do, pop that frame.
